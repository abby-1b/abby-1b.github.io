...
function updateMonth() {
    ...
    if (currMonthElement)
        container.removeChild(currMonthElement);
...
updateMonth();
document.getElementsByClassName("leftArrow")[0].addEventListener("click", () => { currMonth--, updateMonth(); });
document.getElementsByClassName("rightArrow")[0].addEventListener("click", () => { currMonth++, updateMonth(); });
window.onresize = () => {
